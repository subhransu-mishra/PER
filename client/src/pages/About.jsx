        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="text-center bg-white bg-opacity-10 backdrop-blur-sm rounded-3xl p-8 border border-white border-opacity-20">
              <svg className="w-12 h-12 text-black opacity-20 mx-auto mb-6" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="ml-4 text-left">
                  ...
                  <div className="text-black">CFO, TechStart Inc.</div>
                </div>
              </div>
            </div>
          </div>
