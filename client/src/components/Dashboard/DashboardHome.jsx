    ...
    <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Record new expenses</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Record new income</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Manage small expenses</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">View financial reports</p>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h3 className="text-gray-500 text-sm">Petty Cash Balance</h3>
              <div className="text-2xl font-bold mt-1">
                {isLoading ? (
                  <div className="animate-pulse bg-gray-200 h-8 w-24 rounded"></div>
                ) : (
                  `₹${(stats.pettyCash.balance || 0).toLocaleString()}`
                )}
              </div>
            </div>
              ...
              <div className="animate-pulse space-y-4">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="flex items-center">
                    <div className="bg-gray-200 h-10 w-10 rounded-full mr-4"></div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <h3 className="text-lg font-semibold">Financial Calendar</h3>
          </div>
        </div>
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-medium">Monthly Financial Review</h4>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-medium">Tax Filing Deadline</h4>
                <p className="text-sm text-gray-500">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-medium">Vendor Payment Due</h4>
                <p className="text-sm text-gray-500">
